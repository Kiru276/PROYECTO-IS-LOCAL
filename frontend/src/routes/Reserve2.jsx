...
import { createReserve2 } from '../services/reserve.service.js';
...
function PageReserve2() {
  ...
  const [formData, setFormData] = useState({
    ...
    tipo: 'psicotecnico', // Cambia el tipo de reserva a 'psicotecnico'
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await createReserve2(formData);
  ...
  return (
    <div className="reserve-container">
      <h2 className="reserve-title">Formulario de Reserva psicotécnica</h2>
